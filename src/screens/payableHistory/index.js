      ...
      <ScrollView>
        <View style={styles.header}>
          ...
          <View style={styles.headerTitle}>
            <Text style={styles.headerText}>Payable History</Text>
            
          </View>
        </View>
        <Text style={styles.title}>Payable History</Text>
        <View style={styles.content}>
          <View style={styles.subTitleContainer}>
            ...
            <View style={styles.subTitleRight}>
              ...
              <Text style={{fontSize: 24, fontWeight: 700}}>$113.34</Text>
            </View>
          </View>
          ...
          <ReviewBox amount={113.34} review="5.0" time={4} />
          <MainButton 
            bgColor="black" 
            fontColor="white" 
            title="Review"
            icon={<Image source={require('../../../assets/icons/warning.png')} style={{width: 18, height: 18}} />}
            onPress={() => navigation.navigate('Disputed Services Submit')} 
          />
        </View>
      </ScrollView> 
    </SafeAreaView> 
